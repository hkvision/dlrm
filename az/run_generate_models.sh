...
export INPUT_PATH=hdfs://172.16.0.103:9000/dlrm/terabyte
...
export OUTPUT_PATH=hdfs://172.16.0.103:9000/dlrm/terabyte/output
...
export SPARK_HOME=/opt/work/client/kai/spark-2.4.3-bin-hadoop2.7
...
spark-submit --master yarn --deploy-mode client \
        ...
        --model_size_file /opt/work/client/kai/recommendation/terabyte/nvidia/model_size.json \
        --days 0-23 \
        --train_days 0-22 \
        --remain_days 23-23 \
