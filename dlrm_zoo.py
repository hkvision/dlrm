...
if __name__ == "__main__":
    ...
    with np.load("sample_data/train_fea_count.npz") as data:
        ln_emb = data["counts"]
    ...
    if args.cluster_mode.startswith("yarn"):
        kwargs["additional_archive"] = "sample_data.zip#sample_data"
        kwargs["extra_python_lib"] = "qr_embedding_bag.py,md_embedding_bag.py,dlrm_data_pytorch.py,data_utils.py"
